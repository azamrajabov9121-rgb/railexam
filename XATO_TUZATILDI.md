...
`supabase` o'zgaruvchisi ikki marta e'lon qilingan edi. Bu JavaScript da ruxsat etilmaydi.

## Yechim

`supabase-config.js` faylida kod o'zgartirildi:
...
- **Ctrl+Shift+R** (hard refresh - keshni tozalash bilan)
- Yoki **Ctrl+F5**
...
### Supabase Dashboard ga o'ting:
1. SQL Editor ni oching
2. Quyidagi SQL kodlarni ketma-ket bajaring
...
Sahifani yangilang (**Ctrl+Shift+R**) va natijani menga yuboring! 🚀
